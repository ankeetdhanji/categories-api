...
public interface IRoundManager
{
    ...
    /// <summary>Removes a player's done status. Returns false if the round is no longer in the Answering phase.</summary>
    Task<bool> UnmarkPlayerDoneAsync(string gameId, string playerId, CancellationToken ct = default);
